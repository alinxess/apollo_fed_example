...
class QueryPlanningContext {
    ...
    getFieldDef(parentType, fieldNode) {
        ...
        const fieldDef = (0, graphql_2.getFieldDef)(this.schema, parentType, fieldName);
        if (!fieldDef) {
    ...
    getPossibleTypes(type) {
        return (0, graphql_1.isAbstractType)(type) ? this.schema.getPossibleTypes(type) : [type];
    }
    ...
    getBaseService(parentType) {
        const type = (0, composedSchema_1.getFederationMetadataForType)(parentType);
        return (type && (0, composedSchema_1.isEntityTypeMetadata)(type)) ? type.graphName : undefined;
    }
    getOwningService(parentType, fieldDef) {
        var _a, _b;
        return ((_b = (_a = (0, composedSchema_1.getFederationMetadataForField)(fieldDef)) === null || _a === void 0 ? void 0 : _a.graphName) !== null && _b !== void 0 ? _b : this.getBaseService(parentType));
    }
    getKeyFields(scope, serviceName, fetchAll = false) {
        ...
        for (const possibleType of scope.possibleRuntimeTypes()) {
            const type = (0, composedSchema_1.getFederationMetadataForType)(possibleType);
            const keys = type && (0, composedSchema_1.isEntityTypeMetadata)(type)
    ...
    getRequiredFields(scope, fieldDef, serviceName) {
        ...
        const fieldFederationMetadata = (0, composedSchema_1.getFederationMetadataForField)(fieldDef);
    ...
    getFragmentCondition(parentType, fragment) {
        ...
        if (!typeConditionNode)
            return parentType;
        return (0, graphql_1.typeFromAST)(this.schema, typeConditionNode);
    }
