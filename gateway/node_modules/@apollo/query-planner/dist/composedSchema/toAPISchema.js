...
function toAPISchema(schema) {
    ...
    schema = (0, removeInaccessibleElements_1.removeInaccessibleElements)(schema);
    ...
    (0, graphql_1.assertValidSchema)(apiSchema);
...
function isAssociatedWithFeature(element, featureName) {
    return (((0, graphql_1.isDirective)(element) && element.name === featureName) ||
