...
class Scope {
    ...
    static pruneRefinedTypes(toPrune, refiningType) {
        ...
        if (!toPrune.directives && (0, graphql_1.isTypeSubTypeOf)(toPrune.context.schema, refiningType, toPrune.parentType)) {
    ...
    isStrictlyRefining(type) {
        let scope = this;
        while (scope) {
            if (scope.parentType !== type && (0, graphql_1.isTypeSubTypeOf)(this.context.schema, scope.parentType, type)) {
                return true;
            }
