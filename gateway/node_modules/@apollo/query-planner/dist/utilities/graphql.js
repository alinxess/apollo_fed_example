...
function parseSelections(source) {
    ...
    (0, assert_1.assert)(parsed.definitions.length === 1, `Invalid FieldSet provided: '${source}'. FieldSets may not contain operations within them.`);
...
function parseFieldSet(source) {
    ...
    (0, graphql_1.visit)(selectionSetNode, {
        FragmentSpread() {
