...
exports.printBlockString = exports.printType = exports.printIntrospectionSchema = exports.printSubgraphSchema = exports.printSchema = void 0;
const graphql_1 = require("graphql");
const types_1 = require("../types");
const utils_1 = require("../composition/utils");
const directives_1 = require("../directives");
exports.printSchema = printSubgraphSchema;
function printSubgraphSchema(schema) {
    return printFilteredSchema(schema, (n) => !(0, graphql_1.isSpecifiedDirective)(n) && !(0, utils_1.isApolloTypeSystemDirective)(n), isDefinedType);
}
...
function printKnownDirectiveUsagesOnType(type) {
    ...
    if (tagUsages.length === 0)
        return '';
    return ' ' + tagUsages.map(graphql_1.print).join(' ');
}
