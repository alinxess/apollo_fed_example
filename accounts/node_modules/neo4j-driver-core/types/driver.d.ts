...
declare class Driver {
     ...
     */
    constructor(meta: MetaInfo, config: DriverConfig | undefined, createConnectonProvider: CreateConnectionProvider);
    /**
     ...
     */
    session({ defaultAccessMode, bookmarks: bookmarkOrBookmarks, database, fetchSize }?: {
     ...
     * @private
     */
    _newSession({ defaultAccessMode, bookmarkOrBookmarks, database, reactive, fetchSize }: {
        defaultAccessMode: SessionMode;
